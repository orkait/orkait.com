...
<head>
  ...
  <meta name="twitter:site" content="orkaithq" />
...
While GraphQL offers an excellent developer experience for frontend developers, it should primarily be used for composing data from multiple sources. REST/RPC APIs remain the best choice for implementing your business logic. Additionally, you should not hand-write your GraphQL layer. Instead, you can use [orkait](/docs/graphql-configuration-generation-with-orkait/#effortless-rest-integration) to automatically convert your REST APIs to GraphQL.

If you want to know why we think this way, you can read more about it in the article [Writing a GraphQL Backend by Hand is Long Gone](https://orkait.run/blog/writing-a-graphql-backend-by-hand-is-long-gone/).
...
For quickly creating a GraphQL server that converts REST APIs to GraphQL, check out [Getting Started with orkait](/docs).
