...
orkait is The modern way to build GraphQL APIs. All you need to do is install orkait and use the [gen command](/docs/orkait-graphql-cli#gen) to automatically generate the GraphQL API.
