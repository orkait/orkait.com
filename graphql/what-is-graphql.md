...
You can use tools like orkait, which is the simplest way to convert your REST APIs to GraphQL APIs. You can find more details [here](https://orkait.run/docs).
