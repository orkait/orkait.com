...
Ensure you are on the desired branch you want to benchmark, and then build orkait in release mode to optimize performance:
...
Start the orkait server by setting the appropriate environment variable to control log output and using the release binary:
