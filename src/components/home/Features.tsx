...
const Feature = ({feature}: FeatureProps) => {
  return (
    <div className="text-orkait-dark-500 sm:max-w-6xl sm:m-SPACE_10 lg:mx-auto lg:px-SPACE_016 my-0 lg:my-SPACE_20">
      ...
      >
        <div className="bg-gradient-to-b from-orkait-light-100 from-3% via-[#E4E5E9] via-67% to-orkait-light-100 absolute -left-SPACE_04 sm:-left-SPACE_06 w-[2px] h-full" />
