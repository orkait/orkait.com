...
const Testimonials = () => {
    ...
    return (
        <Section className="customer-container !bg-orkait-dark-600 h-full w-full text-orkait-light-100 !bg-contain md:!bg-center md:!bg-top py-16 md:py-20 lg:pt-48 lg:pb-24">
            <div className="flex flex-row items-center justify-center">
                ...
                >
                    <span>Clients</span>
                    <span className="bg-orkait-yellow rounded-lg text-black px-SPACE_01 ml-SPACE_02">trust us!</span>
                </Heading>
            </div>
            ...
            {companies.length > 0 && <TrustedByMarquee title="Trusted by companies" logos={companies} />}
        </Section>
    )
}
