...
const FeatureBox = ({feature}: MoreFeaturesProps) => {
  return (
    <div className="border-b border-0  border-solid border-orkait-border-light-200 flex flex-col sm:flex-row items-start justify-start sm:items-center text-start space-y-SPACE_02 sm:space-y-0 py-SPACE_04 sm:py-SPACE_08 lg:py-SPACE_12 sm:space-x-SPACE_04 text-content-tiny font-bold sm:text-title-small lg:text-title-medium text-orkait-dark-500  sm:h-32 w-full">
  ...
  return (
    <section className="w-full mb-SPACE_08 sm:mb-SPACE_20">
      <div className="max-w-7xl mx-SPACE_04 sm:mx-SPACE_10 lg:mx-auto text-center flex flex-col items-center">
        <Heading
          as="h5"
          className="text-title-semi-large sm:text-display-tiny lg:text-display-small text-orkait-dark-500"
        >
