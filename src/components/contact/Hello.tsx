  ...
  return (
    <section className="relative h-auto">
      ...
      <div className="p-SPACE_06 sm:py-SPACE_10 lg:py-SPACE_20 flex flex-col lg:flex-row items-center lg:items-start justify-center lg:space-x-40">
        ...
        >
          Say <span className="bg-orkait-yellow rounded sm:rounded-2xl px-SPACE_01 sm:px-SPACE_02">hello</span> to us!
        </Heading>
        ...
        <div className="flex flex-col justify-between space-y-SPACE_07 w-full md:w-fit">
          ...
          <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLSfhvf5qoRFmVuNYlElbQVElZW_QWqUoyYBZMtOlLre5ymcLEQ/viewform?embedded=true"
