    ...
    <>
      {open ? (
        <>
          ...
          <div
            className={clsx(
              "absolute w-full lg:w-4/12 h-full overflow-scroll right-0 bg-white rounded-xl lg:rounded-none lg:border lg:border-solid lg:border-orkait-border-light-500 px-4 py-8 lg:px-10 lg:py-8 flex flex-col gap-8",
          ...
          >
            ...
            <div className="flex flex-col gap-5 pb-36">
              <div className="flex items-center gap-3 border border-solid border-orkait-border-light-500 rounded-lg py-3 px-6">
                <Search width={20} height={20} className="text-orkait-light-500" />
                <input
                  name="tag"
                  type="text"
                  value={query}
                  ...
                  className="text-black placeholder:text-orkait-light-500 border-none outline-none text-content-small"
                />
              </div>
                    ...
                    <div className="flex flex-col gap-3 lg:gap-4" key={category}>
                      ...
                      {searchResults?.[category]?.map((tag: BlogTag) => (
                        <Link
                          ...
                          to={tag.permalink}
                          onClick={handleModalClose}
                          className="text-content-small text-black px-3 py-1 border border-solid border-orkait-border-light-500 rounded-3xl w-fit cursor-pointer hover:no-underline"
                        >
                          {tag.label}
                        </Link>
                      ))}
