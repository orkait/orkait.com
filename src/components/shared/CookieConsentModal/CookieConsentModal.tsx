    ...
    <>
      {open ? (
        <>
          ...
          >
            <div className="flex flex-col gap-4 text-orkait-light-300">
              <div className="flex flex-col gap-2">
                ...
                <span className="text-content-tiny xl:text-content-small">
                  ...
                  <Link
                    ...
                    className="text-orkait-light-300 hover:text-orkait-light-300 underline"
                  >
                    Learn More
                  </Link>
                </span>
                    ...
                    return (
                      <span
                        ...
                        className={clsx(
                          ...
                          preference.selected ? "text-orkait-light-600" : "",
                        )}
                ...
                {consentOptions.map((btn: ConsentOption, index: number) => {
                  return (
                    <span
                      key={index}
                      className={clsx(
                        "sm:whitespace-nowrap py-1 px-3 text-title-tiny bg-orkait-dark-400 border border-solid border-orkait-dark-300 cursor-pointer text-center",
