...
const GithubStarsProvider = ({children}: GithubStarsProviderProps) => {
  ...
  // GitHub stars feature disabled - Orkait doesn't have a GitHub repo
  // If Orkait gets a GitHub repo in the future, update the fetch URL here
  // const fetchGithubStars = () => {
  //   return fetch("https://api.github.com/repos/orkait/repo")
  //     .then((resp) => resp.json())
  //     .then((resp) => {
  ...
  // Fetch stars count on component mount - disabled
  // useEffect(() => {
  //   fetchGithubStars()
  // }, [])
