...
import orkaitLogo from "@site/static/icons/companies/orkait-white.svg"
...
const Footer = () => {
    ...
    return (
        <footer className="flex flex-col w-full relative px-4 py-8 lg:px-40 lg:pt-20 lg:pb-0 bg-orkait-dark-700 grid-dark gap-4 lg:gap-8">
            <div className="grid grid-cols-2 gap-8 lg:flex lg:gap-32 xl:gap-64 w-full z-10">


                <orkaitLogo className="w-[120px] h-10 col-span-2" />
                            ...
                            {category.items.map((footerItem: FooterLink, index: number) => {
                                return (
                                    <Link
                                        ...
                                        className="text-content-small lg:text-content-medium text-orkait-light-500 hover:text-orkait-light-300 hover:no-underline leading-[20px] lg:leading-[26px]"
                                    >
                                        {footerItem.name}
                                    </Link>
                                )
            ...
            <div className="flex flex-col lg:flex-row items-center lg:justify-between w-[100%] lg:w-full z-10 py-2 lg:py-6 gap-2 lg:gap-0">
                <p
                    className="text-content-mini lg:text-content-tiny text-orkait-light-700 font-space-mono font-normal cursor-pointer mb-0"
                    onClick={openCookieConsentModal}
                >
                    Cookie Settings
                </p>
                <p className="text-content-mini lg:text-content-tiny text-orkait-light-700 font-space-mono font-normal mb-0">
                    Copyright © {year} Orkait, Inc.
                </p>
