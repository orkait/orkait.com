...
const Playground = () => {
  ...
  const apiEndpointInputClasses = `border border-solid border-orkait-border-light-500 rounded-lg font-space-grotesk h-11 w-[100%]
    p-SPACE_04 text-content-small outline-none focus:border-x-orkait-light-700`
