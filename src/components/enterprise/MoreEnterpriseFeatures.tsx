...
const MoreEnterpriseFeatures = () => {
  return (
    <section className="border border-solid border-orkait-border-light-300 flex flex-col sm:flex-row items-center justify-center sm:px-SPACE_10 lg:px-40 relative overflow-hidden">
      ...
      <div className="border-l border-orkait-border-light-300 flex items-start justify-start gap-SPACE_04 flex-wrap p-SPACE_04 overflow-x-auto h-full max-w-screen-md sm:pl-SPACE_10 sm:py-SPACE_10">
        {additionalEnterpriseFeatures.map((feature) => (
          <div
            className="min-w-[150px] border border-solid border-orkait-border-light-300 flex items-center p-SPACE_02 sm:px-SPACE_04 sm:py-SPACE_03 rounded w-fit space-x-SPACE_02 sm:space-x-SPACE_04"
            key={feature.id}
          >
