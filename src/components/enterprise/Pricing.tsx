...
const Pricing = () => {
  return (
    <section className="my-SPACE_14 sm:my-24 sm:mx-SPACE_04 lg:mx-0">
      ...
      >
        <span className="rounded sm:rounded-lg bg-orkait-yellow px-SPACE_01">Plans</span> that fit your scale.
      </Heading>
      ...
      <div className="flex flex-col mx-SPACE_04 sm:mx-0 lg:flex-row items-center justify-center gap-SPACE_06 md:px-SPACE_16">
        {pricingPlans.map((plan) => (
          <div
            key={plan.id}
            className={`${
              plan.mostPopular ? "border-orkait-border-dark-700" : "border-orkait-border-light-400"
          ...
          >
            {plan.mostPopular && (
              <p className="absolute -top-3.5 left-[50%] transform -translate-x-[50%] bg-orkait-dark-600 text-orkait-light-100 p-SPACE_01 rounded text-content-tiny font-bold">
                Most popular
              </p>
            )}
