...
const EnterpriseFeaturesCard = ({feature}: EnterpriseFeaturesCardProps) => {
  return (
    <div className="border border-solid border-orkait-border-light-400 rounded-3xl w-full sm:w-[450px] sm:h-60 p-SPACE_08 flex flex-col items-start space-y-SPACE_04">
