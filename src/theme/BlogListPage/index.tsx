...
function LoadMoreButton({handleLoadMore}: {handleLoadMore: () => void}) {
  return (
    <div className="flex justify-center">
      <button
        onClick={handleLoadMore}
        className="mt-4 h-12 cursor-pointer rounded-lg border-2 border-solid border-orkait-border-dark-100 bg-transparent px-4 py-2 font-space-grotesk text-title-tiny font-bold text-black"
      >
        Load more blogs
      </button>
    </div>
...
function BlogListPageContent({metadata, items, sidebar}: Props) {
