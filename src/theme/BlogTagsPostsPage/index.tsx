...
function BlogTagsPostsPageContent({tag, items}: Props) {
    ...
    <Layout>
      <div className="container mx-auto mt-3 mb-10 md:my-8 px-4 md:w-8/12">
        <div className="flex flex-col md:flex-row gap-2 mb-5">
          <span className="text-title-medium text-orkait-light-600">Results for</span>
          <span className="flex items-center justify-between flex-1">
            <span className="text-content-small px-3 py-1 text-orkait-dark-100 rounded-full bg-orkait-light-200">
              {tag.label}
            </span>
            <span
              className="text-content-small text-orkait-dark-500 underline cursor-pointer"
