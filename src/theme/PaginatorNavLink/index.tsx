...
function NavigatorIcon({ isNext }: { isNext: boolean }) {
    return (
        <div className="w-10 h-10 p-2 bg-orkait-yellow flex justify-center items-center rounded-full">
    ...
    return (
        <Link className="!no-underline flex gap-3 items-center" to={permalink}>
            ...
            <div className="hidden md:block">
                {subLabel && <div className="text-orkait-dark-100 text-[12px] font-medium">{subLabel}</div>}
